        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={{alignItems:'center'}}>
                <View style={{width:"100%",alignItems:"center"}}>
                    ...
                    />
                    <TouchableRipple 
                        style={{backgroundColor:primary_color,width:"100%",height:35,justifyContent:"center",marginTop:20}}
                        onPress={()=>onPress()}
                        >
                ...
                <View style={{alignItems:"baseline",marginTop:35,width:"100%",height:"100%",backgroundColor:main_color}}>
                    {
                        loaded?(
