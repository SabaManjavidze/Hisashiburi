...
import { domain,img_url, light_primary_color, primary_color } from './variables'
...
export default function MangaCard({route,navigation,item,favs}) {
    ...
    return (
        <View style={[{height:atHome?windowHeight*0.25:"100%"},styles.container]}>
            <View
            ...
            >
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        {atHome&&<View style={{alignItems:"center",justifyContent:"flex-start",height:"100%",width:"10%"}}>
                            <IconButton icon={star} style={{bottom:10}} onPress={()=>onPress()} color={primary_color}/>
                        </View>}
                    </View>
                    <View style={{
                        flex:1,
